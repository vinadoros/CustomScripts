...
if args.stage == 1:
    ...
    ### OSTree Apps ###
    # Cli tools
    rostreeinstall("zsh tmux iotop p7zip p7zip-plugins util-linux-user fuse-sshfs redhat-lsb-core powerline-fonts google-roboto-fonts google-noto-sans-fonts samba smartmontools hdparm cups-pdf pulseaudio-module-zeroconf paprefs tilix tilix-nautilus syncthing numix-icon-theme numix-icon-theme-circle")
