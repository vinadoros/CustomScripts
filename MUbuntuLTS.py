#!/usr/bin/env python3
"""Install Ubuntu Software on the latest LTS release"""
...
parser.add_argument("-d", "--desktop", help='Install the MATE Desktop Environment', action="store_true")
parser.add_argument("-a", "--allextra", help='Install extra software and run Extra Scripts', action="store_true")
...
### Stock software for all cases (CLI Only) ###
install("ssh tmux nano p7zip-full p7zip-rar unrar gdebi-core btrfs-tools f2fs-tools xfsprogs dmraid mdadm")
# Timezone stuff
...
### GUI Only Software
if args.desktop is True:
    # General GUI software
    install("synaptic gdebi gparted xdg-utils leafpad gnome-disk-utility")
    # Cups-pdf
