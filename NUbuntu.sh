...
nscriptadd "$SCRIPTDIR/Comp-UbuntuRepos.sh" "${SETUPSCRIPT}"
...
nscriptadd "$SCRIPTDIR/Comp-DebGChrome.sh" "${SETUPSCRIPT}"

nscriptadd "$SCRIPTDIR/Comp-DebVBoxHost.sh" "${SETUPSCRIPT}"

nscriptadd "$SCRIPTDIR/Comp-DebVMGuest.sh" "${SETUPSCRIPT}"

nscriptadd "$SCRIPTDIR/Comp-VMGeneral.sh" "${SETUPSCRIPT}"
